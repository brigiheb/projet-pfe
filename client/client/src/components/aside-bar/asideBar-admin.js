            ...
            <div>
                <div id="kt_aside" className="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
                    ...
                    <div className="aside-logo flex-column-auto" id="kt_aside_logo">
                        {/*begin::Logo*/}
                        <a href="/">
                            <img alt="Logo" src=" /assets/media/logos/logoblanc.png" className="h-25px logo" />
                        </a>
                        {/*end::Logo*/}
                        {/*begin::Aside toggler*/}
                            ...
                            <div className="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                                ...
                                <div className="menu-item menu-accordion">
                                    <span className="menu-link">
                                        <span className="menu-icon">
                                            ...
                                            <span className="svg-icon svg-icon-2"><CardMembershipIcon /> </span>
                                            {/*end::Svg Icon*/}
                                        </span>
                                        <li className="nav-item">
                                            <a href='Tdegree' className="menu-title" >Degree</a>
                                        </li>
                                    </span>
                                </div>
                                ...
                                <div className="menu-item menu-accordion">
                                    <span className="menu-link">
                                        <span className="menu-icon">
                                            {/*begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg*/}
                                            <span className="svg-icon svg-icon-2"><AccessTimeIcon /></span>
                                            {/*end::Svg Icon*/}
                                        </span>
                                        <li className="nav-item">

                                            <a href="/Tdispo" className='menu-title'>Disponibilite</a>
                                        </li>
                                    </span>
                                </div>
                                ...
                                <div className="menu-item menu-accordion">
                                    <span className="menu-link">
                                        <span className="menu-icon">
                                            {/*begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg*/}
                                            <span className="svg-icon svg-icon-2"><CategoryIcon /> </span>
                                            {/*end::Svg Icon*/}
                                        </span>
                                        <li className="nav-item">
                                            <a href="/Tjcat" className='menu-title'>Category d'emploi </a>
                                        </li>
                                    </span>
                                </div>
                                ...
                                <div className="menu-item menu-accordion">
                                    <span className="menu-link">
                                        <span className="menu-icon">
                                            {/*begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg*/}
                                            <span className="svg-icon svg-icon-2"><AssignmentTurnedInIcon /> </span>
                                            {/*end::Svg Icon*/}
                                        </span>
                                        <li className="nav-item">
                                            <a href="/Texp" className='menu-title'>Experience</a>
                                        </li>
                                    </span>
                                </div>
                                ...
                                <div className="menu-item menu-accordion">
                                    <span className="menu-link">
                                        <span className="menu-icon">
                                            {/*begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg*/}
                                            <span className="svg-icon svg-icon-2"><AbcIcon /> </span>
                                            {/*end::Svg Icon*/}
                                        </span>
                                        <li className="nav-item">
                                            <a href="/Tkeycloud" className='menu-title'>Nuage des clés</a>
                                        </li>
                                    </span>
                                </div>
                                ...
                                <div className="menu-item menu-accordion">
                                    <span className="menu-link">
                                        <span className="menu-icon">
                                            {/*begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg*/}
                                            <span className="svg-icon svg-icon-2"><GradeIcon /> </span>
                                            {/*end::Svg Icon*/}
                                        </span>
                                        <li className="nav-item">
                                            <a href="/Tlevels" className='menu-title'>Niveaux</a>
                                        </li>
                                    </span>
                                </div>
                                ...
                                <div className="menu-item menu-accordion">
                                    <span className="menu-link">
                                        <span className="menu-icon">
                                            {/*begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg*/}
                                            <span className="svg-icon svg-icon-2"><ClassIcon /> </span>
                                            {/*end::Svg Icon*/}
                                        </span>
                                        <li className="nav-item">
                                            <a href="/categoryList" className='menu-title'>Categories</a>
                                        </li>
                                    </span>
                                </div>
                                <div className="menu-item menu-accordion">
                                    <span className="menu-link">
                                        ...
                                        <li className="nav-item">
                                            <a href="/rh" className='menu-title'>Account Requests</a>
                                        </li>
                                    </span>
                                </div>
                                ...
                                <div className="menu-item menu-accordion">
                                    <span className="menu-link">
                                        ...
                                        <li className="nav-item">
                                            <a href="/validrh" className='menu-title'>Comptes Validés</a>
                                        </li>
                                    </span>
                                </div>
                                ...
                                <div className="menu-item menu-accordion">
                                    <span className="menu-link">
                                        ...
                                        <li className="nav-item">
                                            <a href="/library" className='menu-title'>Library</a>
                                        </li>
                                    </span>
                                </div>
                            </div>
