...
export default function InfoRec () {
              ...
              <div className="d-flex justify-content-between align-items-start flex-wrap mb-2">
                ...
                <div className="d-flex flex-column">
                  ...
                  <div className="d-flex align-items-center mb-2">
                    <a href="#" className="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">Nom Recruteur</a>
                    <a href="#">
                ...
                <div className="d-flex my-4">
                  ...
                  <a href="#" className="btn btn-sm btn-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_offer_a_deal">Imprimer</a>
                  {/*begin::Menu*/}
                ...
                <div className="d-flex flex-column flex-grow-1 pe-8">
                  ...
                  <div className="d-flex flex-wrap">
                    ...
                    <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                      ...
                      {/*end::Number*/}
                      {/*begin::Label*/}
                      <div className="fw-bold fs-6 text-gray-400">Offres</div>
                      {/*end::Label*/}
                    </div>
                    {/*end::Stat*/}
                    {/*begin::Stat*/}
                    <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                      ...
                      {/*end::Number*/}
                      {/*begin::Label*/}
                      <div className="fw-bold fs-6 text-gray-400">Candidats Appliqués</div>
                      {/*end::Label*/}
                    </div>
                    {/*end::Stat*/}
                    {/*begin::Stat*/}
