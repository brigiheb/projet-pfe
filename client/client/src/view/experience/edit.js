...
export default function EditExperience() {
    ...
    useEffect(() => {
        const getDataById = async () => {
            const { data } = await axios.get(`http://localhost:5000/experienceGet/${id}`)
            setnmbrExperience(data.nmbrExperience)
    ...
    const putData = async (e) => {
        e.preventDefault()
        const Data = {
            nmbrExperience: nmbrExperience,

        }
        await axios.put(`http://localhost:5000/experienceUp/${id}`, Data)
        navigate('/Texp')
    }
                    ...
                    <div className="card mb-5 mb-xl-10">
                        ...
                        <div className="card-header border-0 cursor-pointer" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                            ...
                            <div className="card-title m-0">
                                <a href='/Texp'><button type="back" className="btn btn-light btn-active-light-primary me-2"><ArrowBackIcon /></button></a>
                        ...
                        <div id="kt_account_profile_details" className="collapse show">
                            ...
                            <form id="kt_account_profile_details_form" className="form" onSubmit={putData}>
                                ...
                                <div className="row mb-6">
                                    {/*begin::Label*/}
                                    <label className="col-lg-4 col-form-label required fw-bold fs-6">Experience</label>
                                    {/*end::Label*/}
                                    {/*begin::Col*/}
                                    <div className="col-lg-8 fv-row">
                                        <input
                                            ...
                                            value={nmbrExperience} onChange={(e) => { setnmbrExperience(e.target.value) }}
                                        />
                                    </div>
                                    {/*end::Col*/}
                                </div>
