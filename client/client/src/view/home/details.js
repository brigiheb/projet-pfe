                            ...
                            <div id="kt_account_profile_details_form" className="form" >
                                ...
                                <div className="row mb-6">
                                    ...
                                    <div className="col-lg-8 fv-row">
                                        <p className="form-control form-control-lg form-control-solid">{titre}</p>
                                    </div>
                                    {/*end::Col*/}
                                </div>
                                {/*end::Input group*/}
                                ...
                                <div className="card-footer d-flex justify-content-end py-6 px-9">
                                    ...
                                    <div className="btn btn-light btn-active-light-primary me-2">
                                        <a href={`/postuler`} className="btn btn-sm btn-primary me-3"  >Postuler</a>
