...
const baseURL = "http://localhost:5000/keycloudGetAll";


export default function TableKeyCloud() {
    const [posts, setPosts] = useState([]);
    const [keyclouds, setKeyclouds] = useState([])
    ...
    function deleteDegree(id) {
        fetch(`http://localhost:5000/keycloudDel/${id}`, {
            method: 'DELETE'
        }).then((result) => {
                        ...
                        <div className="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div className="card-header border-0 pt-5">
                                <h3 className="card-title align-items-start flex-column">
                                    <span className="card-label fw-bolder fs-3 mb-1">Mots Clés</span>
                                </h3>
                                <div className="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add an offer">
                                    <a href='/keyCloud' className="btn btn-sm btn-light btn-active-primary" >
                                    ...
                                    <table className="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                        ...
                                        <thead>
                                            <tr className="fw-bolder text-muted">
                                                ...
                                                <th className="min-w-160px">Mot Clé</th>
                                            ...
                                            {posts.map((post) => (
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href={`/editKeycloud/${post.id}`} className="btn btn-sm btn-primary me-3"  >Modifier</a>
                                                    </td>
