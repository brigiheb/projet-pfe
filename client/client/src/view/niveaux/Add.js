...
const baseURL = "http://localhost:5000/levelPost";
                    ...
                    <div className="card mb-5 mb-xl-10">
                        ...
                        <div className="card-header border-0 cursor-pointer" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                            ...
                            <div className="card-title m-0">
                                <a href='/Tlevels'><button type="back" className="btn btn-light btn-active-light-primary me-2"><ArrowBackIcon /></button></a>
                                <h3 className="fw-bolder m-0">Niveaux </h3>
                            </div>
                            {/*end::Card title*/}
                        </div>
                        {/*begin::Card header*/}
                        ...
                        <div id="kt_account_profile_details" className="collapse show">
                            ...
                            <form id="kt_account_profile_details_form" className="form" onSubmit={handleSubmit}>
                                ...
                                <div className="row mb-6">
                                    {/*begin::Label*/}
                                    <label className="col-lg-4 col-form-label required fw-bold fs-6">Niveaux</label>
                                    {/*end::Label*/}
                                    {/*begin::Col*/}
